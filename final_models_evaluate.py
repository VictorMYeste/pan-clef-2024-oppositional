...
english_model_path = get_model_folder_name('en', 'google/electra-base-discriminator', DEFAULT_RND_SEED, 'conspiracy')
english_model = SklearnTransformerClassif.load(english_model_path)

# Load the Spanish model
spanish_model_path = get_model_folder_name('es', 'PlanTL-GOB-ES/roberta-base-bne', DEFAULT_RND_SEED, 'conspiracy')
